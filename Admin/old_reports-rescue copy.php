            ...
            <table class="rounded-border">
                ...
                <tr>
                    ...
                    <td style="width: auto;">
                        ...
                        <button onclick='openSharedModal("edit", <?= $json ?>)' class='btn btn-success action-btn'>More Details</button>
                        <button onclick='openDeleteModal(<?= e($row[$pk]) ?>,"<?= e($row[$pk]) ?>")' class='btn btn-warning action-btn'>Go to Location</button>
                    </td>
                </tr>
                <?php endforeach; ?>
                </tbody>
