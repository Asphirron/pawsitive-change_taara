...
// -------------------- CONFIG --------------------
$tableName = 'adoption';   // Change this to your table
$pk = 'adoption_id';       // Primary key column of the table
...
$fieldsConfig = [
    ...
    'animal_id' => 'fk',
    'date_adopted' => 'date',
    'status' => ['pending', 'adopted', 'returned']
];
...
$filterConfig = ['animal_id', 'user_id', 'date_adopted', 'status'];
...
$setPropertyConfig = [
    'table_name' => 'adoption',
    'property' => 'status',
    'values' => ['adopted', 'returned'],
    'modal_title' => 'Handle Adoption',
    'button_text' => ['Set as Adopted', 'Set as Returned'],
...
$defaultColumns = ['adoption_id','user_id','animal_id','date_adopted','status'];
...
<main class="content flex-c">
    <header class='top-nav flex-r'>
        <a href='adoptions-records.php' class='top-active'>Adoptions</a>
